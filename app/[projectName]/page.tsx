  ...
  return (
    <>
      <div className="project flex">
        ...
        <div className="projectImages projectImagesContainer absolute left-[35%] pb-32 ">

          {/* the div wrapping the image slider only */}
          <div className="scrollerContainer w-full overflow-scroll"
          // style={{ height: 'calc(100vh + 210vw)' }}
          >
            <div className="scrollerWrapper overflow-scroll">
              <div className="imagesSlider w-full flex gap-2 " ref={containerRef}
              // style={{ height: 'calc(100vh + 210vw)' }}
              >
                {mainImage && (
                  <Image
